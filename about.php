  ...
  I believe great software is more than just code—it's about solving real problems, enhancing user experiences, and designing interfaces that connect seamlessly with people’s needs and workflows.
      ...
      <div class="achievements">
        <div>
          <i class="icon">🏅</i>
          <h4>Design Awards</h4>
          <p>Multiple recognition for creative excellence</p>
        </div>
        <div>
          <i class="icon">😊</i>
          <h4>Client Satisfaction</h4>
          <p>98% client retention rate</p>
        </div>
        <div>
          <i class="icon">⚡</i>
      ...
      <!-- RESUME BUTTON -->
      <a href="assets/docs/resume.pdf" class="btn-primary" download>⬇ Download Resume</a>
    </div>
